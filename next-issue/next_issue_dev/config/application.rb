...
module DefaultRails
  class Application < Rails::Application
    ...
    config.assets.paths = [
      ...
      Rails.root.join("app", "assets", ENV['VIEW_PATH'] || ENV['APP_NAME'], "images"),
      Rails.root.join("app", "assets", ENV['VIEW_PATH'] || ENV['APP_NAME'], "javascripts"),
      Rails.root.join("app", "assets", ENV['VIEW_PATH'] || ENV['APP_NAME'], "stylesheets"),
      Rails.root.join("app", "assets", ENV['VIEW_PATH'] || ENV['APP_NAME'], "fonts")
    ]
