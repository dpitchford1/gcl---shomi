...
SimpleForm.setup do |config|
  ...
  config.wrappers :inline_text_medium, :tag => 'div', :class => 'controls fancy-select-medium float-left', :id => '', :error_class => 'error' do |b|
    b.use :html5
    b.use :min_max
    b.use :maxlength
    b.use :placeholder
    ...
    b.optional :autocapitalize
    b.optional :autocorrect
    b.wrapper :tag => 'div', :class => 'fancy-select-medium' do |ba|
      ba.use :label_input
      # ba.use :input
  ...
  config.wrappers :form_row_text, :tag => 'div', :class => 'form-row', :id => '', :error_class => 'error' do |b|
    b.use :html5
    b.use :min_max
    b.use :maxlength
    b.use :placeholder
  ...
  config.wrappers :inline_larger_checkbox, :tag => 'div', :class => 'larger-form-row', :error_class => 'error' do |b|
    b.use :html5
    b.use :placeholder
    b.wrapper :tag => 'div', :class => 'controls' do |ba|
      ba.use :label_input, :wrap_with => { :class => 'checkbox inline' }
  ...
  config.wrappers :inline_select_medium, :tag => 'div', :class => 'controls', :id => '', :error_class => 'error' do |b|
    b.use :html5
    b.use :placeholder
    b.wrapper :tag => 'div', :class => 'select-wrap fancy-select fancy-select-medium' do |ba|
      ba.use :input
      ba.use :error, :wrap_with => { :tag => 'p', :class => 'help-inline' }
      ba.use :hint,  :wrap_with => { :tag => 'small', :class => 'help-block' }
    end
  ...
  config.wrappers :fancy_select_medium, :tag => 'div', :class => '', :error_class => 'error' do |b|
    b.use :html5
    b.use :placeholder
    b.use :label
    b.wrapper :tag => 'div', :class => 'controls select-wrap fancy-select fancy-select-medium' do |ba|
      ba.use :input
      ba.use :error, :wrap_with => { :tag => 'p', :class => 'help-inline' }
      ba.use :hint,  :wrap_with => { :tag => 'small', :class => 'help-block' }
    end
  end
  config.wrappers :fancy_select_small, :tag => 'div', :class => '', :error_class => 'error' do |b|
    b.use :html5
    b.use :placeholder
    b.use :label
    b.wrapper :tag => 'div', :class => 'controls select-wrap fancy-select fancy-select-sm' do |ba|
      ba.use :input
      ba.use :error, :wrap_with => { :tag => 'p', :class => 'help-inline' }
      ba.use :hint,  :wrap_with => { :tag => 'small', :class => 'help-block' }
    end
